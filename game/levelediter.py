...
blob_img = pygame.image.load('barnacle.png')
platform_x_img = pygame.image.load('grassHalf.png')
platform_y_img = pygame.image.load('castleCenter.png')
lava_img = pygame.image.load('Lava (2).png')
coin_img = pygame.image.load('hud_coins.png')
exit_img = pygame.image.load('doorKnob.png')
